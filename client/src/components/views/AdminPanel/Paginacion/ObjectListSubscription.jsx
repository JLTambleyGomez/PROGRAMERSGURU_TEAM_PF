...
export default function ObjectsListSubscription({ objects, titulo, handleDeleteSubscription, handleEditSubscription }) {
    ...
    return (
        <div className={s.paginacion}>
            ...
            <div className={s.header}>
                ...
                <div className={s.title}>Título</div>
                    ...
                    return (
                        <div key={obj.id} className={s.fila}>
                            <div key={obj.id}></div>
                                ...
                                <div className={s.type}>{obj.type}</div>
                                <div className={s.price}>{obj.price}</div>
                                <div className={s.actions}>          
                                        <button onClick={() => handleDeleteSubscription(obj.id)} className={styles.deleteButton}>
                                    ...
                                    <button onClick={() => handleEditSubscription(obj.id)} className={styles.modificarButton}><svg xmlns="http://www.w3.org/2000/svg" className={styles.mod} width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
