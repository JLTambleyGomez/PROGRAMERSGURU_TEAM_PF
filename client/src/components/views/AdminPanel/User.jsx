...
import {getAllUsersRequest, putUserRequest, hideUserProfileRequest, adminUserRequest} from '../../../axiosRequests/axiosRequests'
    ...
    return (
        <div className={styles.contain} >
            ...
            {allUsers.length && allUsers.map((user, index )=>{
                return (
                    <span>
                        <button onClick={handleModificar} value={user.id} name='datos' >Modificar datos</button>
                        <button onClick={handleModificar} value={user.id} name='administrador' >Hacer Adminitrador</button>
                        <button onClick={handleModificar} value={user.id} name='banear' >Banear</button>
                        <label key={index}>
                            ...
                            <p>Suscripción: {user.expirationDate ? user.expirationDate : false }</p>
