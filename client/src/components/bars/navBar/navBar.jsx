    ...
    return (
        ...
        {/* CURSOS */}
            <button className={`${s.button} ${s[theme("button")]} ${s.inicio}`}>
                ...
                </NavLink><div className={`${s.hide}`}>Explora nuestros cursos</div>
            </button>
        {/* TIENDA */}
            <button className={`${s.button} ${s[theme("button")]} ${s.inicio}`}>
                ...
                </NavLink><div className={`${s.hideTienda}`}>Deleitate con nuestros productos</div>
            </button>
        {/* CARRITO */}
            <button className={`${s.button} ${s[theme("button")]} ${s.inicio}`}>
                ...
                </NavLink><div className={`${s.hideCarrito}`}>Resumen de compras</div>
            </button>
        {/* SEARCHBAR */}
